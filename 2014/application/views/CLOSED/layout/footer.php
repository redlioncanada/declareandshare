		...
		<div class="row">
			<div class="col-xs-12 col-md-4">
				<div class="footer-box">
					<h4><?=lang('find_your_mixer')?></h4>
					<p><?=lang('find_your_mixer_text')?></p>
					<a href="http://www.kitchenaid.ca/<?=lang('lang_code')?>/findyourmixer/" class="btn" onclick="te('common','skip-share','');"><?=lang('find_your_mixer_link')?></a>
				</div>
			</div>
			<div class="col-xs-12 col-md-4">
				<div class="footer-box">
